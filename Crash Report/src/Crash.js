...
export class Configuration {
  constructor(accessToken, options) {
    ...
    this.captureUncaught =
      options.captureUncaught !== undefined ? options.captureUncaught : true;
    this.captureUnhandledRejections =
    ...
    this.captureDeviceInfo =
      options.captureDeviceInfo === undefined
        ? false
        : options.captureDeviceInfo;
    ...
    this.ignoreDuplicateErrors =
      options.ignoreDuplicateErrors !== undefined
        ? options.ignoreDuplicateErrors
        : undefined;
  }
